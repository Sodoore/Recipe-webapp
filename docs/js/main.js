...
class Search {
  ...
  async doSearch() {
    try {
      let result = await axios__WEBPACK_IMPORTED_MODULE_0___default()("https://forkify-api.herokuapp.com/api/search?q=" + this.query);
      this.result = result.data.recipes;
      return this.result;
    } catch (error) {
      console.log("ALdaaaaa : " + error);
    }
  }
...
/* harmony export */ });
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ "./src/js/viev/base.js");
...
const renderRecipes = function (recipes) {
  ...
  let resPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3;
  // Хайлтын үр дүнг хуудаслаж үзүүлэх
  const start = (currentPage - 1) * 3;
  const end = currentPage * 3;
  recipes.slice(start, end).forEach(el => renderRecipe(el)); // Хуудаслалтын точнуудыг гаргаж ирэх

  const totalPages = Math.ceil(recipes.length / resPerPage);
  renderButtons(currentPage, totalPages);
}; // type ====> "next" or "prev"

const createButton = (page, type, direction) => " <button class=\"btn-inline results__btn--".concat(type, "\" data-goto=").concat(page, ">\n<svg class=\"search__icon\">\n    <use href=\"img/icons.svg#icon-triangle-").concat(direction, "\"></use>\n</svg>\n<span>\u0425\u0443\u0443\u0434\u0430\u0441 ").concat(page, "</span>\n</button>");
...
/* harmony import */ var _viev_base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./viev/base */ "./src/js/viev/base.js");
/* harmony import */ var _viev_searchView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./viev/searchView */ "./src/js/viev/searchView.js");
...
const controlSearch = async () => {
  ...
  const query = _viev_searchView__WEBPACK_IMPORTED_MODULE_3__.getInput();

  if (query) {
    // 2) Шинээр хайлтын обьектыг үүсгэж өгнө.
    state.search = new _model_search__WEBPACK_IMPORTED_MODULE_1__["default"](query); // 3) Хайлт Хийхэд зориулж дэлгэцийг (UI) бэлтгэнэ.

    _viev_searchView__WEBPACK_IMPORTED_MODULE_3__.clearSearch();
    (0,_viev_base__WEBPACK_IMPORTED_MODULE_2__.renderLoader)(_viev_base__WEBPACK_IMPORTED_MODULE_2__.elements.searchResultDiv); // 4) Хайлтыг гүйцэтгэнэ.

    await state.search.doSearch(); // 5) Хайлтын үр дүнг дэлгэцэнд үзүүлнэ.

    (0,_viev_base__WEBPACK_IMPORTED_MODULE_2__.clearLoader)();
    if (state.search.result === undefined) alert("Хайлт илэрцгүй байна");else _viev_searchView__WEBPACK_IMPORTED_MODULE_3__.renderRecipes(state.search.result);
  }
};

_viev_base__WEBPACK_IMPORTED_MODULE_2__.elements.searchForm.addEventListener("submit", e => {
  e.preventDefault();
  controlSearch();
});
_viev_base__WEBPACK_IMPORTED_MODULE_2__.elements.pageButtons.addEventListener("click", e => {
  const btn = e.target.closest(".btn-inline");

  if (btn) {
    const gotoPageNomber = parseInt(btn.dataset.goto, 10);
    _viev_searchView__WEBPACK_IMPORTED_MODULE_3__.clearSearch();
    _viev_searchView__WEBPACK_IMPORTED_MODULE_3__.renderRecipes(state.search.result, gotoPageNomber);
  }
});
})();
